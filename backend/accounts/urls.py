...
from .views import UserRegisterApiView, UserLoginApiView, UserGetSuggestedApiView, UserFollowUnfollowApiView, UserGetFollowedApiView, UserLikeOrDislikePostApiView, UserCommentPostApiView, UserGetByIdApiView
...
urlpatterns = [
    ...
    path("<int:user_id>", UserGetByIdApiView.as_view(), name="get-user"),
